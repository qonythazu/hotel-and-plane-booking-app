<div>
    ...
    <div class="row setup-content {{ $currentStep != 1 ? 'd-none' : '' }}" id="step-1">
        <div class="col-12">
            <div class="col-md-12">
                ...
                <div class="mb-3">
                    <p>Tanggal Booking: {{ \Carbon\Carbon::parse($d->check_in)->format('d F Y') }}</p>
                </div>
                <div class="mb-3">
        ...
        <div class="col-12">
            <div class="col-md-12">
                ...
                <div class="form-group">
                    ...
                    @error('nama_pemesan') <span class="error">{{ $message }}</span> @enderror
                </div>
                <div class="form-group pt-3">
                    <label for="description">Nomor Telpon</label>
                    <input type="telp" wire:model="nomor_hp" class="form-control" id="productStock"/>
    ...
    <div class="row setup-content {{ $currentStep != 3 ? 'd-none' : '' }}" id="step-3">
        <div class="col-xs-12">
            <div class="col-md-12">
                <h3>Pastikan Pesanan Anda Benar</h3>
                <table class="table">
                    <tr>
                        <td>Pemesan:</td>
                    ...
                    <tr>
                        <td>Pesanan:</td>
                        <td><strong>Hotel {{ $d->produk->nama_produk }} ({{ $d->produk->deskripsi }})</strong> <br> <i class="far fa-calendar-check fa-xs"></i> {{ \Carbon\Carbon::parse($d->check_in)->format('d F Y') }} --- <i class="far fa-user fa-xs"></i> {{ $jumlah }} orang</td>
                        <td></td>
                    </tr>
                    <tr>
                        <td>Tanggal Pemesanan:</td>
                        <td><strong>{{ \Carbon\Carbon::parse($tanggal)->format('d F Y') }}</strong></td>
                        <td></td>
                    </tr>
                    <tr>
